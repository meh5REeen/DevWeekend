...
const Login = () => {
    ...
    return (
        ...
        sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400 text-white"> 
            ...
            <div className = "bg-slate-900 p-10 rounded-lg shadow-lg q-full sm:w-96 twxt-indigo-300 text-sm">
                <h2 className="text-3xl font-semibold text-white text-center mb-3">{state === "Sign Up" ? "Create account" : "Login"}</h2>
                
                <p className="text-center text-white text-sm mb-6">{state === "Sign Up" ? "Create your account" : "Login to your account"}
                </p>
