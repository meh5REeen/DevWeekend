...
const Header = () => {
    ...
    return(
        <div className="flex flex-col items-center mt-20 px-4 text-center text-gray-800">
            ...
            <h2 className="text-3xl sm:text-5xl font-semibold m-4">Welcome to our App</h2>
            <p className="mb-8 max-w-md">Let's start, cause you have got no time on thhis earth got it?!</p>
